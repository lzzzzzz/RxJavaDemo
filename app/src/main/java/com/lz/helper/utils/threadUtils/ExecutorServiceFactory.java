package com.lz.helper.utils.threadUtils;
...
public class ExecutorServiceFactory {
    private static final int cpu_executors_number=3;//每个cpu创建的线程的个数
    ...
    public ExecutorService createScheduledThreadPool() {
        ...
        // 创建
        executors = Executors.newScheduledThreadPool(availableProcessors * cpu_executors_number, getThreadFactory());
        return executors;
    }
